 ...
 * DESCRIPTION
 * ---------------------------------------------------------------------------------------------------------------------
 * This file contains the comparison benchmark of React EventLoop.
 * Benchmark has been run according to the library v0.4.3
 *
 * ---------------------------------------------------------------------------------------------------------------------
 * USAGE
 * ---------------------------------------------------------------------------------------------------------------------
 ...
 * libraries.
 *
 * $> php ./example-bench/benchmark-react.php
 *
 * ---------------------------------------------------------------------------------------------------------------------
 */
